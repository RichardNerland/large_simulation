    ...
    return html.Div([
        ...
        html.Div([
            html.Div([
                ...
                html.H3("Step 2: Set Initial Investment", style={'color': '#2c3e50', 'marginTop': '25px'}),
                html.P([
                    "Enter the initial investment amount. The dashboard will calculate how many students can be funded based on the program-specific cost per student. ",
                    "A small portion (2%) of the investment is reserved as a cash buffer."
                ], style={'fontSize': '16px', 'lineHeight': '1.6'}),
                
                html.H3("Step 3: Run Simulation", style={'color': '#2c3e50', 'marginTop': '25px'}),
                html.P([
                    "Click 'Run Percentile Simulation' to generate results across five percentile scenarios (P10, P25, P50, P75, P90). ",
                    "Each percentile represents a different distribution of degree outcomes, with higher percentiles indicating more favorable outcomes."
                ], style={'fontSize': '16px', 'lineHeight': '1.6'}),
