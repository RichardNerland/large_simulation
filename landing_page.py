        ...
        html.Div([
            html.Div([
                ...
                html.Ul([
                    ...
                    html.Li([html.Strong("GiveWell Comparison: "), "Compare the ISA program's *total net present value utility (PV)* generated from the $1M investment to direct cash transfers... This tab now also explicitly shows the ISA program's impact as a 'multiple of cash effectiveness' relative to GiveDirectly."])
                ], style={'fontSize': '16px', 'lineHeight': '1.6', 'paddingLeft': '30px'}),
                ...
                html.Ul([
                    ...
                    html.Li([html.Strong("Avg Earnings Gain: "), "Average increase in lifetime earnings per graduated student"]),
                    html.Li([html.Strong("Total Program Net Utility (PV): "), "The total net present value of welfare generated by all graduated students from the $1M investment, measured in utils. This is a key measure for overall program cost-effectiveness."]),
                    html.Li([html.Strong("Average Student Total Utility (PV): "), "The average net present value of welfare gain per graduated student, providing insight into individual impact."])
                ], style={'fontSize': '16px', 'lineHeight': '1.6', 'paddingLeft': '30px'}),
